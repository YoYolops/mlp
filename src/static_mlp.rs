...
impl SMLP {
    ...
    pub fn save_weights(&self, path: &str) -> Result<()> {
        ...
        // Write structural constants (metadata to ensure compatibility)
    ...
    pub fn load_weights(&mut self, path: &str) -> Result<()> {
        ...
        // Check if stored weights are compatible with current structure
        ...
        // If structure matches, load parameters
        ...
        // Check for unexpected extra data after all expected data is read
        // Indicates weights generated by other MLP structure, therefore leading two unexpected behavior
